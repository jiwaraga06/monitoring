...
<body>
    <div class="container" style="padding-top: 20px;">
        ...
        <div class="row">
            <h5>-- PRODUKTIFITAS DYEING FINISHING</h5>
        </div>
        <table class="table table-bordered" style="margin-top: 5px; text-align: center;">
            <thead>
                <tr>
                    <th rowspan="2" style="text-align: start; align-items: center;">
                        <h6 style="margin-bottom: 25px;">PRODUKTIFITAS DYEING</h6>
                    </th>
                    <th colspan="2">
                        <h6>HARI</h6>
                    </th>
            ...
            <tbody> """;
    body['dyeing'].forEach((key, b) {
      
      totalBatch = totalBatch + b['bacth'];
      totalMeter = totalMeter + b['meter'];
      totalBatchPerbulan = totalBatchPerbulan + b['bacth_perbulan'];
